...
# Quelles données, ouvrables ou non, avez-vous dans vos services ?
...
# Exercice de cartographie de données
...
#### Etape 3.3 : rendre les données (réellement) réutilisable en choisissant la bonne licence
