...
### Rappel de la .red[journée précédente]

#### Maintenant vous savez :

* Définir l'open data et ses principes d'ouverture
* Définir les différentes notions "d'open" dans le domaine de la culture
* Quel est le cadre juridique s'appliquant en France et ses spécificités concernant les oeuvres culturelles
* Quels sont les enjeux et les motivations de l'ouverture de données dans le domaine de la culture
* Raconter quelques projets emblématiques en France et à l'international
...
---
### Conséquence pour .red[les réutilisations] 
...
### Les formats, un gage de qualité  
...
---
### Travail des données, .red[les étapes :]
...
### 1- Définir .red[les données] que l'on souhaite utiliser


#### Que cherche-t-on à savoir, à comprendre, à mesurer ? 
...
* La fréquentation d'un établissement ?
* La localisation .
* Le profil des visiteurs ?
* Les chiffres d’adhésion ?
...
### 2 - Trouver .red[les données] que l'on souhaite utiliser


#### Où trouve-t-on les données que l’on a définies, sont-elles ouvertes ou pas ? Peut-on toutes les trouver ? Sont-elles à jour, organisées ?
...
* Plateforme open data du Ministère
...
### 3 - Comment récupère-t-on .red[ces données ?]


#### Sont-elles faciles à récupérer ? Doit-on scraper, télécharger ?
...
### 4 - Vérifier .red[les données ?]


#### Est-ce que toutes les sources des documents où on est allé récupérer les données sont citées ? Que nous disent les metadata des données ?
...
Nous devons vérifier si les données sont valides, vérifier et lire les métadonnées, la méthodologie de collecte, si nous savons qui a organisé l'ensemble de données et que c'est une source crédible.
...
### 5 - A-t-on besoin de nettoyer .red[les données ?]


#### Un des plus grands défis rencontré est les erreurs.

.pull-left[

![](./img/5-nettoyer.png)

Ceux qui publient les données ne les remarquent pas toujours, dans d’autres cas, elles sont humaines et résultent de la mauvaise saisie de données.
...
#### Outils pour nettoyer les données :
* Open Refine
* R (tidydata), Python
...
---
### 6 - Quelle analyse faire des .red[données collectées ?]


#### Que peut-on conclure à partir des données collectées et des questions posées initialement ?
...
### 7 - Comment présenter .red[ces données ?]


#### Quel graphique utiliser pour quelle visualisation ?
...
### Vous êtes prêts pour participer au 
...
* **Camille Domange** : Ouverture et partage des données publiques culturelles, 209 pages (2013) 
https://www.ladocumentationfrancaise.fr/rapports-publics/144000037/index.shtml
Editeur : Ministère de la culture et de la communication


* **Nicolas Poulain**, « Les musées départementaux de la Haute-Saône et Wikipédia : de l'institution à la contribution », La Lettre de l’OCIM [En ligne], 164 | 2016, mis en ligne le 01 mars 2017, consulté le 31 juillet 2019. URL : http://journals.openedition.org/ocim/1642 ; DOI : 10.4000/ocim.1642
