...
> * Comprendre les problématiques et les enjeux liés aux données du secteur culturel.
...
4. Les outils de l'ouverture des données
5. Cadre juridique de l’ouverture des données culturelles
6. Plusieurs exemples #OpenGLAM
...
- En donnant du sens à la connaissance on obtient du **.red[savoir]**.
] 
...
C’est en 1995 qu’on en voit le premier usage public aux Etats-Unis dans un rapport de la National Academy of Science intitutlé "_On the Full and Open Exchange of Scientific Data_". Dans le langage courant, cela fait .red[**près de 15 ans**] que l'ouverture des données est devenue un élément majeur des politiques publiques numériques. 
...
* .red[politiques] : appels de citoyens pour une plus grande transparence de l’action publique qui garantit un meilleur contrôle démocratique
...
Le contexte est alors marqué par l’essor considérable des technologies et de l’économie numérique.
...
## Quatre dates clés dans .red[l'histoire mondiale de l'open data]
...
### 2013 : la [charte du G8 sur l'open data](https://www.etalab.gouv.fr/leschefsdetatdug8signentunechartepourlouverturedesdonneespubliques/#:~:text=Cette%20Charte%20Open%20Data%20du,les%20formats%20ouverts%20et%20non%2D)
...
### Conclusion : des .red[principes et une définition] qui se stabilisent en une dizaine d'années
...
* **.red[Des principes appropriables par les gouvernements]** : le travail du G8 en 2013 et plus tard de la Charte Internationale de l'Open Data rend les principes intégrables par les gouvernements.  
...
### L'open data au .red[Ministère de la Culture]

> Le ministère de la culture s’est doté dès avril 2013 d’une « feuille de route open data », comportant dix actions pour une stratégie numérique de diffusion et de réutilisation des données publiques numériques du secteur culturel. 

---

### Les .red[dates importantes] à retenir 1/2
...
### Les .red[dates importantes] à retenir 2/2
...
.red[**2024**] : Une nouvelle nouvelle nouvelle feuille de route ["numérique et données"](https://nextcloud.datactivist.coop/s/H6tExD68sq8riHs) est rédigée
...
La [feuille de route](https://www.culture.gouv.fr/Espace-documentation/Documentation-administrative/Feuille-de-route-Donnees-et-contenus-culturels) de 2021 concerne les données, les algorithmes et les codes sources.
...
Les moyens pour atteindre ces objectifs sont :
...
### .red[Question d'actualité] : quelle place pour les données culturelles à l'ère de l'IA générative ?

* Période avec beaucoup d'incertitudes sur les données d'entrainement des IA générative

* Mission relative à la rémunération des contenus culturels utilisés par les
systèmes d’intelligence artificielle confiée au Conseil supérieur de la propriété littéraire et artistique en avril 2024 (résultats attendus été 2025)

* Choix de la BNF de passer un [accord avec un consortium d'acteurs](https://next.ink/142051/la-bnf-un-reservoir-de-donnees-pour-les-ia/)

* 2 juin 2025 : Lancement de la concertation entre les développeurs de modèles d'IA générative et les ayants droits culturels

> Sujet brûlant à suivre... Ce qu'il faut avoir en tête c'est qu'aujourd'hui les données (ouvertes mais pas que) servent aussi à ça
...
* Prendre la vague...
: bénéficier des apports de l'IA qui permet de bénéficierd'un apport d'expertise et d'analyse précieux (étude des collections parexemple)

* ...en veillant aux grains
: l'IA pose de nombreux problèmes : cybersécurité,intégrité scientifique, droits d’auteur, diversité et inclusion, écologie, dignitéhumaine…

Ressources : [Culture et Recherche n°147](https://www.culture.gouv.fr/thematiques/enseignement-superieur-et-recherche/la-revue-culture-et-recherche/recherche-et-intelligence-artificielle) et [Charte de l'IA générative](https://semaphore.culture.gouv.fr/system/files/database/documents/2024-06/charte-intelligence-artificielle-generative-ministere-culture.pdf)
---

### .red[Question d'actualité] : quelle place pour les données culturelles à l'ère de l'IA générative ?

Le Ministère a publié une [Stratégie IA](https://www.artcena.fr/sites/default/files/medias/StrategieActionIA_VDIFF_VF.pdf) en juillet 2025, elle contient les axes suivants : 

* Développer des IA et des usages responsables

* Créer les conditions d'une modèle économique équitable et protecteur des créateurs

* Innover et renouveler l'offre culturelle, de sa création à sa diffusion
Utiliser l'IA comme levier de découvrabilité, de connaissance et de protection des biens culturels

* Déployer l'IA au service des usagers et des agents
...
### Data.gouv : .red[thématique culture]

[![](img/DG_theme_cult.png)](https://www.data.gouv.fr/fr/pages/donnees_culture/)
...
+ Des plateformes open data gérées par des **entreprises**. Exemple [DataNova](https://datanova.laposte.fr) (La Poste)
...
---
### Le portail .red[data.culture.gouv.fr]
...
---
### Un ministère qui .red[joue le jeu]

Le ministère publie 2 éléments intéressants pour s'orienter et connaître sa démarche open data :
* Le [catalogue des données du Ministère](https://data.culture.gouv.fr/explore/dataset/catalogue-des-donnees-du-ministere-de-la-culture/information/?disjunctive.sous_domaine)

* Le [calendrier des futures publications de jeux de données](https://www.culture.gouv.fr/Thematiques/Innovation-numerique/Actualites/Open-data-decouvrez-le-calendrier-d-ouverture-du-ministere-de-la-Culture)

---

class: inverse, center, middle

# 5 - Éléments juridiques relatifs à l'ouverture des données
...
1. **Directive PSI** de (2003, 2013 et 2019)
...
---
### Evolution de le directive PSI en .red[2019]

Maintien d'un cadre d'exception pour le secteur culturel (bibliothèques, archives, musées)

>Pour les documents à l'égard desquels des bibliothèques, y compris des bibliothèques universitaires, des musées et
des archive sont titulaires de droits de propriété intellectuelle [...] les États membres veillent à ce que, lorsque la réutilisation de ces documents est autorisée, ces derniers puissent être réutilisés à des fins commerciales ou non commerciales.

Art. 3 de la directive

PSI autorise la perception de redevances pour les données culturelles mais sous condition de critères.
...
### [.red[Rijksstudio]]((https://www.rijksmuseum.nl/en/rijksstudio))
...
[En savoir plus sur la politique de la donnée](https://www.rijksmuseum.nl/en/research/conduct-research/data)
...
Les + de la démarche : tableau de bord des effets de la [stratégie open content](https://www.clevelandart.org/virtual-cma-dashboards/collection-online-dashboard) et contenus 3D ouverts.
...
.pull-left[
En 2017, la plateforme **collections.musee-bretagne.fr** propose ses collections en téléchargement gratuit.

Important travail sur [l'origine des collections pour les rendre réutilisable](https://musee-devoile.blog/2022/04/25/des-collections-en-partage-droits-dauteur-genealogie-et-pedagogie/).
...
Enjeux : partage, accès, interopérabilité des métadonnées.

Des projets :
* [Hadoc](https://www.culture.gouv.fr/Media/Documentation/Harmonisation-des-donnees-culturelles/Files/MCC-HADOC-REF-modele_harmonise_donnees_culturelles.pdf)
* [OpenThéso](https://opentheso.huma-num.fr/opentheso/#)
* Thésaurus en Skos de dataculture(http://data.culture.fr/thesaurus/)
---

### Profiter du potentiel du .red[web semantique]

[Crotos](https://zone47.com/crotos/), est un moteur de recherche qui s’appuie sur Wikidata et donne ainsi accès à des œuvres en s'appuyant sur la force du web semantique. 

[Palladia](http://zone47.com/crotos/palladia/), est un moteur de recherche et d'affichage d'une partie des collections du Musée Saint-Raymond.
...
Dans le futur : une aide à l'indexation ? Un exemple avec la reconnaissance des entités nommées basées sur Wikidata

http://nerd.huma-num.fr/nerd/

---

### Valoriser .red[sa démarche]

Le label [Culture Libre](https://www.wikimedia.fr/label-culture-libre/) de Wikimedia France valorise le travail des GLAM pour l'ouverture et le partage des savoirs

1ère remise de labels le 25 avril 2023 à l'INHA à 16 institutions.
2ème "promo" en 2024 avec 8 nouveaux lauréats.

![](img/Culturelibre.jpeg)
*Photo : Wikimedia France*
...
#### Penser à [mesurer l'impact des actions mises en oeuvre](https://www.data.gouv.fr/fr/posts/impact-des-donnees-ouvertes-1-6/)
* Dès le lancement du projet en identifiant bien ses objectifs
...
* [**Guide pratique dédié à l’ouverture des données publiques culturelles**](https://www.culture.gouv.fr/Media/Thematiques/Innovation-numerique/Folder/Guide-pratique-dedie-a-l-ouverture-des-donnees-publiques-culturelles)
...
* [**Numérisation et valorisation des contenus culturels : guide ouverture et réutilisation des informations publiques numériques du secteur culturel**](https://www.culture.gouv.fr/Media/Thematiques/Innovation-numerique/Folder/Livrables-GT-Numerisation/Numerisation-et-valorisation-des-contenus-culturels-guide-ouverture-et-reutilisation-des-informations-publiques-numeriques-du-secteur-culturel),publié par le ministère de la Culture, 2017

* [**Guide de bonnes pratiques en matière de propriété littéraire et artistique**](https://www.culture.gouv.fr/Media/Thematiques/Innovation-numerique/Folder/Livrables-GT-Numerisation/Guide-de-bonnes-pratiques-en-matiere-de-propriete-litteraire-et-artistique), publié par le ministère de la Culture, 2017
...
* [**Guide pratique pour la recherche et la réutilisation des images d’œuvres d’art**](https://numrha.hypotheses.org/2537), INHA

* [**Droits des images, histoire de l’art et société**](https://iconautes.inha.fr/fr/index/rapport-images-usages.html)

---

### Bibliographie 4/4

* [**Stratégie d’action IA du Ministère**](https://www.artcena.fr/sites/default/files/medias/StrategieActionIA_VDIFF_VF.pdf)
