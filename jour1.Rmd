...
> Le mouvement de l'open data est largement **influencé par le mouvement du logiciel libre** qui lui précède de quelques décennies, et dont les créateurs participèrent à en dessiner les contours, notamment en 2007, lors de la conférence de Sébastopol sur laquelle nous reviendrons. 

**Comment ?**

* Historiquement venu des pratiques des chercheurs en informatique des années 70-80, le partage d'information, de données et un modèle de la recherche scientifique de l'époque. 
...
### .red[Principes] du Logiciel Libre 
...
### Des principes du logiciel libre .red[aux facettes de l'open data]
...
* **L’Open Access** (le libre accès) est la mise à disposition en ligne de contenus numériques, soit sous licences libres (Creative commons, etc.), soit sous un des régimes de propriété intellectuelle.
...
* **L’Open Data** (les données ouvertes), est la mise à disposition gratuite sur Internet de données .red[sous réserve que des tiers ne détiennent pas des droit de propriété intellectuelle sur ces informations.]
...
### .red[ La participation citoyenne à l’action publique]
...
# Origines historiques de l'open data en France et dans le monde
...
### Le baromètre international de l'Open Data
...
### L'Open Data Index de l'Open Knowledge Foundation
...
* **DINSIC - Etalab** : Crée en 2011, la mission coordonne la politique d’ouverture et de partage des données publiques, et anime la plateforme nationale data.gouv.fr 
...
# 3 - Éléments juridiques relatifs à l'ouverture des données

---

### .red[Droit d’ouverture des données publiques] en France
...
### .red[Les conditions d'exercice] du droit d'accès aux données et documents administratifs
...
# 4 État-Plateforme et gouvernement ouvert
...
### .red[Les collections en ligne] : le Rijksstudio
...
# 6 - Concevoir une stratégie open data
