...
### Open data : un mouvement .red[né pour répondre à différents enjeux et besoins]

**Historiquement, la naissance de l'open data repose sur différentes facettes** : 
...
---
### 2010 : .red[l'ère des classements]

**[Le baromètre international de l'Open Data](https://opendatabarometer.org/?_year=2017&indicator=ODB)** est un classement de référence, tout comme l'Open Data Index de l'Open Knowledge Foundation, organisation internationale ayant pour objet de promouvoir la transparence des données publiques.
...
### Conclusion : des .red[principes et une définition] qui se stabilisent
...
* Exemple : [**Est-ce que l'on remarque plus les trains à l'heure ou ceux en retard ?**](https://data.centrevaldeloire.fr/pages/ponctualite-ter-exintercites/) 

.center[![](img/region_centre.png)]
...
systèmes d’intelligence artificielle confiée au Conseil supérieur de la propriété littéraire et artistique en avril 2024
...
- Mener le projet d'ouverture des données comme un .red[**projet de modernisation de l'administration**] (transversalité, agilité, lean...)
