...
### Pour les .red[services centraux, les DRAC et les SCN] : des données hébergées sur data.culture.gouv.fr et visibles (aussi) sur data.gouv.fr

![](./img/data.culture.gouv.fr.png)

Pour les les données de l'administration centrale, d'une DRAC ou d'un SCN, la mise à disposition des données est à effectuer sur le site  .red[data.culture.gouv.fr.]
