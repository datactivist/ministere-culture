...
> * Comprendre les contraintes des réutilisateurs pour respecter les bonnes pratiques de l'ouverture
...
#### .red[Ecoutez] [l'interview de Serge Abiteboul, commissaire scientifique de l’exposition Terradata et directeur de recherche à l’Inria](https://www.youtube.com/watch?v=qqvsiTUJy7k)
...
### .red[Une définition] des données
...
---
### .red[Des principes techniques] sans portée politique
...
### Les .red[acteurs politiques] de l'open data
...
### .red[Une politique Open Data] pilotée au niveau national
...
### Possibilité d'héberger ses données sur data.gouv.fr .red[pour les établissements publics]
...
# 4. Revue des principes de l'ouverture des données 
...
## 3.a La loi CADA : fondement de la transparence administrative
---
...
---
### .red[Les conditions d'exercice] du droit d'accès
...
## 3.b Synthèse des apports de la loi pour une République numérique
...
### .red[Premier principe] : l'ouverture des données par défaut
...
### .red[Deuxième principe] : création d’un service public de la donnée
...
---
### .red[Troisième principe] : l'utilisation de standards ouverts
...
---
### .red[Quatrième principe] : une limitation des licences
