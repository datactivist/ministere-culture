...
### Une .red[définition des "bases de données"]
...
### Des principes du logiciel libre aux facettes de l'open data
...
Ces principes sont fondamentaux dans le futur développement de politiques nationales d’ouverture des données. 
Ils sont issus de la culture du mouvement du Libre dont les protagonistes sont à l'origine de cette rencontre et réflexion. 
...
### Culture : trois types de données .red[concernées par l’ouverture]  

* 1 - Les données statistiques et économiques des institutions culturelles (fréquentation, recettes, subventions, etc. ) ; 
* 2 - Les métadonnées culturelles, c’est-à dire les notices bibliographiques et plus largement les données associées aux œuvres (localisation ; description ; auteur ; œuvres associées ; prix ; propriétaire) ; 
...
### .red[Contre-exemple] : les Archives de la Planète du musée Albert Kahn

> **La réutilisation commerciale des images y est interdite**
...
* POP propose plusieurs types de recherche, répondant à tous les modes d’interrogation, du plus large au plus précis : une recherche par texte libre, par facettes, une recherche cartographique ainsi qu'une recherche avancée par base de données.
...
* La plate-forme permet le versement de métadonnées en interne (images, photographies, informations descriptives ou réglementaires). 
