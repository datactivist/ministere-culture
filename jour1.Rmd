...
Source : Le guide Cada-Cnil sur l'open data 
...
* **L’Open Data** (les données ouvertes), est la mise à disposition gratuite sur Internet des données (comme les métadonnées qui accompagnent une image, les données statistiques, mais aussi les images ou vidéos), sous réserve que des tiers ne détiennent pas des droit de propriété intellectuelle sur ces informations.
...
![](./img/donnees_conventions_subvention.png)
...
# 4. Éléments juridiques et principes d'ouverture des données 
...
### La loi CADA : fondement de la transparence administrative
---
...
### .red[L'ouverture des données par défaut], un des principes de la Loi Lemaire
...
### .red[Le guide CADA-CNIL] : le document de référence
...
.center[<img src="https://datactivist.coop/aaf/img/guide.png" height="300"/>]

[Source : Guide Open Data Cnil](https://www.cnil.fr/sites/default/files/atoms/files/guide_open_data.pdf)

---

### .red[La loi CADA] : quelques imperfections

Même si la France est le 3e pays à avoir adopté un droit d'accès, la loi CADA n'est pas un outil fort de la transparence de la vie publique. Ses principaux défauts : l'absence de sanctions et une procédure longue qui souvent décourage les demandeurs d'information et de données.
[![](https://datactivist.coop/aaf/img/europam.png)](http://europam.eu/?module=country-profile&country=France)

---

### Un droit d'accès très faible .red[au regard des standards internationaux]

.pull-left[Paradoxe : la France a une législation parmi les plus ambitieuses au monde en matière d'open data mais le droit d'accès à l'information y est un des plus mauvais au monde…
...
## Synthèse des apports de la loi pour une République numérique
...
## 3.c Les spécificités de l'ouverture des données culturelles
...
La plateforme POP regroupe les contenus numériques du patrimoine français afin de les rendre accessibles et consultables au plus grand nombre sur : *pop.culture.gouv.fr* 
