...
Ces slides en ligne :https://datactivist.coop/ministere-culture/classevirtuelle072020.html
...
* L’ouverture des données et la modernisation de l’Etat 
* Les projets emblématique de l'Open Data culturel
...
![](https://raw.githubusercontent.com/datactivist/aaf/master/img/pdr.png)
...
# L'histoire de l'Open Data en France et dans le monde
...
* **DITP** : Expérimente l’intelligence artificielle dans les administrations avec Etalab et la DINUM
* **DINUM** : Soutient la diffusion de la culture numérique (utilisations des données, recours aux méthodes agiles) et la coopération avec la société civile et les écosystèmes innovants (open data, gouvernement ouvert). 
* **Mission Société Numérique de l'Agence du Numérique** : Structure les acteurs de l’accompagnement au numérique et les stratégies numériques des territoires, dont l'open data fait partie.

---

### Au .red[ministère de la Culture]

Le département en charge de l'administration des données et, en particulier de l'ouverture des données, est le *Département du numérique pour la transformation des politiques culturelles et de l'administration des données (Depnum)* au sein du Service du numérique. Il est le correspondant pour le ministère de la culture et ses opérateurs auprès de la mission Etalab (DINUM)." 

Il est chargé :
*	de coordonner le recensement et la qualification des informations publiques, et l’ouverture des données susceptibles d’être mises à disposition
*	d’accompagner les producteurs de données dans l’ouverture de leurs données publiques
*	d’administrer la plateforme data.culture.gouv.fr
*	Il est le point de contact entre usagers et services producteurs de données publiques, en relayant toutes les questions posées sur data.gouv.fr et sur data.culture.gouv.fr

_n’hésitez pas à le contacter pour toute question sur l'Open data_
...
+ Des jeux de données directement publiés sur le site des producteurs de données, sans plateforme dédiée. Exemple : l'Insee.
...
* accès et extraction des données brutes, sous différents formats, y compris API

* présentation graphique et cartographique des données quand cela est possible

* visibilité sur les réutilisations

* fonctionnalités pour animer la communauté
...
### .red[data.culture.gouv.fr] : lieu de publication des données de l'administration centrale, d'une DRAC ou d'un SCN
...
### .red[data.gouv.fr] : lieu de publication des établissements publics
...
Suite à une consultation publique menée par le ministère qui invitait les citoyens à répondre à la question : “quelles sont les données publiques culturelles stratégiques que vous souhaitez voir ouvertes à la réutilisation libre et gratuite ?”

La consultation avait mis en avant trois types de données publiques particulièrement recherchées :

* 1- Les données statistiques et économiques des institutions culturelles (fréquentation, subventions…) 

* 2- Les métadonnées culturelles

* 3- Les fichiers images et copies numériques des œuvres entrées dans le domaine public.
...
> "Seuls les documents librement communicables à tous (au sens de la loi) et sur lesquels des tiers ne détiennent pas de droits de P.I sont des « informations
publiques » et relèvent du droit de réutilisation."
...
.pull-right[
On trouvera ainsi facilement les bases avec le plus d'enregistrements comme la [base Joconde](https://data.culture.gouv.fr/explore/dataset/base-joconde-extrait/information/) qui décrit les oeuvres des musées de France et contient environ 600 000 notices.
...
#### Dans le domaine de la culture, la licence ouverte fait référence à  :

* La possibilité de reproduire, copier, diffuser, redistribuer, publier et transmettre "l’information";

* Adapter, modifier, extraire et transformer à partir de "l'information", notamment pour créer des "informations dérivées";

* Avec obligation de mentionner la paternité et la dernière date de mise à jour;
...
### Zoom sur les licences ouvertes et .red[ODBL] 
...
> Afin de donner de la visibilité à la collection des musées départementaux, et à travers elle à la collectivité détentrice de cette collection, d'envisager l'enrichissement de cette collection et des données associées via cette mise en ligne et de diffuser de la culture, **le réseau de musées a réalisé un partenariat avec l’encyclopédie Wikipédia**, pour diffuser [les données d'images haute définition des collections départementales](https://commons.wikimedia.org/wiki/Commons:Mus%C3%A9es_d%C3%A9partementaux_de_la_Haute-Sa%C3%B4ne) sous licence libre. 
...
---
### .red[Des collections en partage] : une pratique d'ouverture réalisée par .red[le musée de Bretagne]

En 2017, la plateforme **collections.musee-bretagne.fr** propose ses collections en téléchargement gratuit. Une volonté de la métropole de Rennes de rendre accessibles les collections, participant ainsi à la consolidation de sa politique d’ouverture des données. La licence appliquée autorise la réutilisation des documents (images et notices), y compris à des fins commerciales.

> **Environ 170 000 objets et documents numérisés sont concernés par cette ouverture des collections**. 
...
# 5 - État-Plateforme et gouvernement ouvert
...
Initialement fondé par 8 pays (Brésil, Indonésie, Mexique, Norvège, Philippines, Afrique du Sud, Royaume-Uni et États-Unis), le PGO en compte désormais 78, dont la France.
...
### Les engagements du .red[Ministère de la Culture]

Dans les engagement 5 et 9 concernant *l'action des administrateurs ministériels des données* et *l'accompagnement de la mise en œuvre du principe d’ouverture par défaut*, ainsi que l'ouverture de l’administration à de nouvelles compétences
et initiatives *d’innovation ouverte* au sein de l’Etat, le *Ministère de la Culture* s'engage à :

* Fournir et formaliser un accompagnement pédagogique sur les spécificités de l'ouverture, de la diffusion et de la réutilisation des contenus culturels ;
* Accompagner les opérateurs publics à ouvrir et diffuser leurs informations publiques ;
* Poursuivre l'accompagnement des administrations et des opérateurs culturels dans la formalisation de projets pour l'appel à projets EIG ;
* Soutenir le développement de services numériques innovants. 

---
### Des efforts à poursuivre

* De nombreuses informations encore produites dans des formats techniques difficilement exploitables
* Des données parcellaires liées à leur mode de production
* Des données publiques encore commercialisées
* Concurrence des détenteurs de donneés

MAIS
* Moins de naïveté
* Une dynamique nouvelle
* De nouvelles questions et de nouveaux enjeux

---

class: inverse, center, middle

# 6 - Les projets emblématiques de l’open data culturel
...
### Des musées qui ouvrent leurs collections

* En 2013, le [Getty Museum](https://www.getty.edu/museum/) place les reproductions de 4 600 de ses œuvres sous le régime de l’Open Content. Aujourd’hui, c'est plus de 115 000 œuvres qui sont concernées. 
...
* Lancé en 2012 pendant la période de travaux du [.red[Rijksmuseum d’Amsterdam]](https://www.rijksmuseum.nl/en), le [Rijksstudio](https://www.rijksmuseum.nl/en/rijksstudio) est d’abord le catalogue en ligne des collections de l’institution. Son innovation principale est la place accordée aux utilisateurs, qui, une fois inscrits, peuvent créer leurs propres albums thématiques et télécharger toutes les images d’œuvres entrées dans le domaine public, librement et en haute définition.

---
### Les politiques .red[Open Content]

Le Rijksmuseum, le Cleveland Museum of Arts, le MET ou encore Paris Musées ont fait le choix de proposer des reproductions numériques de leurs oeuvres en Open Content.

Toutes les images issues d'œuvres du domaine public de leur collection sont disponibles sous la licence Creative Commons Zero (CC0). Le public a la possibilité de partager, collaborer, remixer et réutiliser les images à des fins commerciales et non commerciales.

.pull-left[Au MET, pour faciliter la recherche, il est possible de filtrer par œuvres appartenant au domaine public. Toutes les images en Open Access sont marquées du logo CC0]


.pull-right[ 

.center[<img src="./img/MET_download_icon.jpg" height="200"/>]
...
# Ouverture et créativité : réutilisations et nouvelles écritures


---

### [.red[GIF IT UP]](https://gifitup.net/) par Europeana

.pull-left[
![](https://media.giphy.com/media/U4FOlK1uczqRvl0mqE/source.gif)
(*Justin Gammon (Greenville, USA) Source : Exercise 5. For the legs generally The New York Public Library via DPLA*)
]
.pull-right[

![](https://media.giphy.com/media/eKJNa8jK6RyzV6pLE4/source.gif)
(*Gatis Štempelis (Liepāja, Latvija) Source : Arkeologiskt föremål från Teotihuacan Sigvald Linné |Etnografiska museet via Europeana*)

]

---
### Le festival [.red[Cultures Remix]](https://medium.com/canope-idf/r%C3%A8glement-du-festival-culturesremix-e8b61e7fc028) par Réseau Canopé

.pull-left[
![](https://miro.medium.com/max/1600/1*HSR2VoMkIUMFv3WP-bTFTA.jpeg)]

.pull-right[

![](https://pbs.twimg.com/media/DzqzQHnX4AEOF1a?format=jpg&name=medium)]
...
.center[<img src="./img/incrustezvous1.png"/>] 
...
.center[<img src="./img/incrustezvous2.png"/>] 

---

### Les bots littéraires

.center[<img src="./img/botmallarme.png"/>] 
...
* **Les coûts temporels et financiers** : extraction, anonymisation, hébergement des données, numérisation des œuvres ...  
...
* **La crainte d'un mauvais usage** : quelques cas minoritaires de mauvaises réutilisations avec des données détournées de leur vrai sens une fois sorties de leur contexte.  
...
Publié par le Ministère de la Culture, Septembre 2019, URL : https://www.culture.gouv.fr/Sites-thematiques/Innovation-numerique/Donnees-publiques/Open-data-un-guide-pratique-dedie-aux-donnees-publiques-culturelles2
...
Publié par le ministère de la culture, Février 2020, URL : https://www.culture.gouv.fr/droitsdediffusion/

* **Livre blanc "Droit des images, histoire de l'Art et société**
Publié par l'Institut National de l'Histoire de l'Art, Novembre 2018, URL : https://www.inha.fr/fr/actualites/actualites-de-l-inha/en-2018/rapport-final-du-programme-images-usages.html
