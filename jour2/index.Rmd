...
Quels autres enjeux voyez vous pour les données culturelles ?
...
* Quelles données et quelles bases de données avez-vous dans vos services ?

.center[![](img/jan-antonin-kolar-lRoX0shwjUQ-unsplash.jpg)]
...
### Prioriser les données à ouvrir

Pour établir une liste de priorité, il faut s'interroger :

* Sur la politique de l'établissement
* Sur les enjeux identifiés comme prioritaires 
* Sur les publics que l'on cible

Une fois ce travail réalisé, on pourra analyser les données au prisme de ces choix
