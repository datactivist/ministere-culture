...
Cette obligation concerne les *administrations d’Etat*, les *collectivités* locales de *plus de 3 500 habitants*, les établissements publics et les organismes privés chargés d’un service public de plus de 50 agents.
...
La Loi pour une République Numérique prévoit deux licences à utiliser par défaut par les administrations pour accompagner la réutilisation gratuite de leurs données s :

* **1 - La licence ouverte v2.0 (LO)**, qui permet la réutilisation la plus large possible, autorisant la reproduction, la redistribution, l’adaptation et l’exploitation commerciale des données ; 
* **La licence Open Database License (ODbL)**, qui autorise les utilisateurs à partager, modifier et utiliser librement une base de données à condition que la rediffusion soit effectuée dans des conditions identiques (« share alike »).

---

### L'utilisation de .red[standards ouverts]
