...
* Cas d'étude de l’open data culturel 
...
Mais, bien avant cela, l'open data s'inscrit dans une série de continuités historiques qui en font un **mouvement aux multiples facettes…**
---
...
# 3. Revue des principes de l'open data 
...
> **Idéalement dans le domaine public sinon dans une licence conforme à l'[Open Definition](www.opendefinition.org). Par décret, deux licences sont homologuées en France : Licence Ouverte (CC-BY) ou ODBL (CC-BY-SA)** 
