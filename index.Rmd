...
1. Tour d’horizon des portails d’open data 
...
### 7. Des données publiée .red[dans un format ouvert]
...
![](https://datactivist.coop/openbelgium/img/etapes.png)

???

L'institution est toujours la première réutilisatrice de ses propres données
...
* Etalab
* Mission Société Numérique de l'Agence du Numérique
* 
