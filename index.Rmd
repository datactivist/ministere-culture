...
* Spécificités de la mise en œuvre de l'open data dans le secteur culturel
...
* Cadre juridique de l’ouverture des données 
* Open government et Etat plateforme : l’ouverture des données dans la modernisation de l’Etat 
* Les success stories de l’open data culturel 
* La conception d’une stratégie d’open data : principaux leviers politiques, organisationnels, économiques 
* Aperçu des principaux acteurs politiques, économiques et associatifs de l’open data 
* Les formats de données 
* Tour d’horizon des portails d’open data 
...
---
### [.red[Principe n°1 :]](https://books.openedition.org/cdf/5005?lang=fr) la transparence

Aller au-delà du droit d'accès et de la réédition des comptes (_accountability_) : réduire les asymétries d'information en accédant au matériau brut de l'information et du savoir

.reduite.center[![](https://datactivist.coop/aaf/img/ddhc.png)]

---
### [.red[Principe n°2 :]](https://books.openedition.org/cdf/5005?lang=fr) la libre circulation de l’information
...
###  [.red[Principe n°3 :]](https://books.openedition.org/cdf/5005?lang=fr) la demande de données brutes
...
### [.red[Principe n°4 :]](https://books.openedition.org/cdf/5005?lang=fr) l'industrie de la donnée
...
### .red[Principe n°5 :] la modernisation des administrations
...
.center[<img src="https://datactivist.coop/aaf/img/declaration.png" height="350"/>]

---

### [Le fonctionnement du PGO](http://www.opengovpartnership.org/sites/default/files/OGP_Booklet_20160911_FR.pdf)

.center[.reduite[![](https://datactivist.coop/aaf/img/opengov.png)]]
...
* Développe et anime la plateforme d’open data data.gouv.fr destinée à rassembler et à mettre à disposition l’ensemble des informations publiques de l’Etat, de ses établissements publics et, si elles le souhaitent, des collectivités territoriales et des personnes de droit public ou de droit privé chargées d’une mission de service public ;
...
# 5 Les success stories de l’open data culturel

---

### DoReMus :  DOing REusable MUsic Data
...
---
### Les Archives de la Planète .red[du musée Albert Kahn]

* La collection d'autochromes d'Albert Kahn de 72 000 photographies en couleur sur plaques de verre prises entre 1909 et 1931 dans plus de 50 pays, est disponible en open data.

* Le fonds iconographique est disponible sous la forme d’un jeu de données accessible à partir **du portail open data Hauts-de-Seine.**

* Une **politique d’ouverture des données culturelles** et d’**accès à la culture pour tous**, mise en oeuvre par le Département des Hauts-de-Seine
...
### Les portails institutionnels pour valoriser .red[les ressources culturelles numériques]


[Le portail Data Culture : data.culture.gouv.fr](https://data.culture.gouv.fr) s'accompagne de ressources annexes :


* Guide [ouverture et réutilisation des informations publiques numériques du secteur culturel](http://www.culturecommunication.gouv.fr/content/download/183534/2002721/version/1/file/GT_2-1-1.pdf) publié (*en janvier 2017*)

* L'[open data culture en 2 minutes](http://www.dailymotion.com/video/xyqrun_tutoriel-de-l-open-data-culture_news) : vidéo tutoriel

* Le rapport [Ouverture et partage des données publiques culturelles](http://www.culturecommunication.gouv.fr/content/download/94768/851739/version/1/file/201312_Rapport_Open_Data_Culturel.pdf) (*publié en décembre 2013*)

* Le [guide data culture](http://www.culturecommunication.gouv.fr/var/culture/storage/culture_mag/donnees_culturelles2013/index.htm) (*publié en mars 2013*)

---

### Le site Data.bnf, .red[précurseur et innovant]

Data.bnf.fr extrait, transforme et regroupe dans une **base commune** des données issues de ressources internes et extérieures, produites dans des formats différents, afin de les lier entre elles et de les rendre interopérables.
Ses pages sont indexées par les moteurs de recherche,

.center[<img src="./img/data_BNF.png" height="300"/>] 
...
* de décrire et identifier les documents conservés à la BnF, ainsi que les personnes ou organisations qui en sont les auteurs. 
...
### Les politiques Open Acess : .red[Cleveland Museum of Arts (U.S)]
...
### Les politiques Open Acess : Cleveland Museum of Arts (U.S)
...
### Les politiques Open Acess : .red[le MET Museum]
...
![](./img/demarche_open-data.png)

.footnote[Source: Open Data France. "L’ouverture des données publiques par et pour les collectivités locales".
...
- Aller vers un .red[**service public de la donnée culturelle**]

- Poser la question des .red[**données d'intérêt général**]

- .red[**Réarmer le service public**] à l'heure de la révolution des données : big data, algorithmie, apprentissage automatisé... 
...
# 7 Aperçu des principaux acteurs politiques, économiques et associatifs de l’open data
---
...
# 9 Tour d’horizon des portails d’open data
...
### Les diverses solutions disponibles

* **Un portail spécifique**

C'est le cas de [data.culture.gouv.fr](https://data.culture.gouv.fr/pages/home/)

![](./img/data.culture.gouv.fr.png)

* **Héberger ses données sur Data.gouv.fr**

La plateforme de diffusion de données publiques (« open data ») de l'État français a été lancée en 2011, et avec la version qu'on lui connait, en 2014. 

> Le design de la plate-forme en ligne montre qu’elle met en avant un « écosystème » où sont censés évoluer
divers acteurs : les producteurs publics de données, les citoyens internautes réutilisateurs et des développeurs indépendants, créateurs des applications et services permettant cette réutilisation. 

.footnote[Mabi Clément, « La plate-forme « data.gouv.fr » ou l’open data à la française », Informations sociales, 2015/5 (n° 191), p. 52-59. [URL](https://www.cairn.info/revue-informations-sociales-2015-5-page-52.htm)]

---

### Les solutions techniques ou offres d’hébergement de portail en France
