...
* Conception d'une stratégie open data
* Identification des données 
* Les formats de données 
* Frictions à l’ouverture des données : comment éviter les obstacles de l’open data ? 
...
* créer votre compte et celui de votre structure sur data.gouv.fr
...
* 1.1 Effectuer un état des lieux permettant de faire .red[**l’inventaire des données existantes.**] 
...
* 1.2 L'évaluation permet de prioriser l’ouverture de vos jeux de données.
...
### .red[Prioriser la publication de données]
...
---
### Etape 2 : Préparer les données
#### 2.1 Choisir la licence de réutilisation
...
Joindre au fichier de données, à chaque fois que cela est utile, des documents associés permettant de rendre les 
données plus explicites, et d'en éclairer l'usage.

Le document en question pourra par exemple être dictionnaire des différentes variables présentes dans le fichier, la signification en clair des codes des libellés des champs. 
...
---
### Etape 2 : Préparer les données
#### 2.3 Choisir un .red[format ouvert]
...
#### 3.1 utiliser la bonne plateforme de publication
#### 3.2 Rendre les données découvrables
#### 3.3 Mettre en place une API pour diffuser des données
...
.pull-left[
.center[<img src="./img/meta_dataculture.png" />]
ainsi que des éléments générés automatiquement (date de publication, de modification...)
]

.pull-right[
.center[<img src="./img/meta_datagouv.png" />]
]

.red[**Ces informations sont indispensables et donnent un maximum de visibilité à vos données dans les moteurs de recherche**.]

---
### Étape 3 : .red[Diffuser et valoriser] les données

#### 3.3 Mettre en place une API pour .red[faciliter les intéractions]
